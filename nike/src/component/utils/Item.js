  ...
  return (
    ...
    <div className={`grid items-center ${ifExists? 'justify-items-start':'justify-items-center'}`}>
      ...
      <div className='flex items-center gap-3'>
        ...
        <button type='button' className='bg-white opacity-90 blur-effect-theme button-theme px-2 py-1 shadow shadow-sky-200 text-sm text-black' onClick={()=> {addToCart(); onCartToggle()}} >
          {btn} 
        </button>
      </div>
    </div>
